...
export default function BetTicker({ bets }) {
  return (
    <div className="bg-gray-800 rounded-2xl border border-gray-700 h-[600px] flex flex-col shadow-2xl overflow-hidden">
              ...
              <tr key={i} className={`transition-colors ${bet.type === 'win' ? 'bg-green-900/10 hover:bg-green-900/20' : 'hover:bg-gray-700/30'}`}>
                ...
                <td className="px-6 py-4 text-center">
                    <span className={`px-3 py-1 rounded-full text-xs font-black uppercase tracking-wider ${
                        bet.type === 'win' ? 'bg-green-500/20 text-green-400 border border-green-500/50' : 
